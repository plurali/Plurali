...
export type PluralMemberEntry<I extends Record<string, string> = Record<string, string>> =
  BaseEntry<PluralMemberContent<I>>
...
export interface GetPluralMembersData extends BaseData {
  systemId: string
}
...
export type GetMembersResponse<
  I extends Record<string, string> = Record<string, string>
> = PluralMemberEntry<I>[]
