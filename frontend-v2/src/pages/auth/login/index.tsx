import { $auth } from "@/app/auth/AuthService";
...
import { AlertType, useAlert, useAlertState, useClearAlerts } from "@/store/alert";
...
export const LoginPage = () => {
    const { handleSubmit, register, formState: { errors } } = useForm<AuthRequestInterface>();
