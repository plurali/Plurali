...
export const Editor = ({ initialValue = "", placeholder = "Start writing", forceSave = false, onSave }: EditorProps) => {
    ...
    return <>
        <UserContent>
            ...
            }} value={parsedValue} editor={editor}>
        ...
        {(forceSave || dirty) && (
            <div className="mt-5 flex justify-end items-center py-4" >
                <button className="text-white bg-violet-700 md:w-48" onClick={handleOnSave}>Save</button>
            </div>
        )}
    </>
