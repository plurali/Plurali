...
const accessibleWithoutPluralKey = ["dashboard:index", "dashboard:user"];

export const isAccessibleWithoutPluralKey = (route: RouteLocationNormalized) =>
  accessibleWithoutPluralKey.includes((route.name ?? route.path).toString());
