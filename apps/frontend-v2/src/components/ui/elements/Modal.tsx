...
export const Modal = ({
  ...
  const iconContainerColorClass = useMemo(
    () =>
      color
        ? {
      ...
      <Dialog as="div" className="relative z-10" onClose={() => !loading && setValue(false)}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-2xl bg-white p-8 text-left shadow-2xl transition-all sm:my-8 sm:max-w-sm lg:max-w-7xl !w-full">
                {loading && (
