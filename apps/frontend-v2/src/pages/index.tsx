...
export default function Index() {
  ...
  return (
    <PageWrapper>
      <HeroWrapper style={mainBackground} className="!py-56 relative overflow-clip">
        <div className="flex flex-col-reverse md:flex-row justify-between h-full w-full mx-auto">
            ...
            <div className="text-center md:text-left">
              ...
              <div>
                <ButtonLink
                  ...
                  className="block text-black font-medium bg-white py-3.5 px-8 rounded-full"
                >
          ...
          <div className="w-full pb-6 lg:pr-6">
            <HeroWrapper hoverable={true} href="/about/fun" className="bg-cyan-400">
              <div>
                ...
                <HeroSubtitle>
                  Plurali uses your Simply Plural for info about your system and it's members.
                </HeroSubtitle>
              </div>
